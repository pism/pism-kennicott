...
parser.add_argument(
    ...
    dest="ensemble_file",
    help="""Choose set.""",
    default="ensemble_kennicott_climate_lhs_500.csv",
)
...
scripts = []
runlength = 5000
odir = "2023_06_20_uq_climate_phi_90"
